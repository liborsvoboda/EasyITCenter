    ...
    public class SiteTemplate : IDisposable
    {
        ...
        public void Delete(string SiteTemplateId)
        {
            ...
            while (ParentDirectoryList.Count >= 1)
            {
                ...
                Directory.Delete(StaticObject.ServerMapPath(StaticObject.SitePath + "template/site/" + TmpPath + "/"), IsLastDirectory);
        ...
        public List<XmlDocument> SetTemplatePhysicalPathDocumentList(List<ListItem> TemplatePhysicalPathNameNumber)
        {
            ...
            foreach (ListItem item in TemplatePhysicalPathNameNumber)
            {
                ...
                doc.Load(StaticObject.ServerMapPath(StaticObject.SitePath + "template/site/" + item.Text));
