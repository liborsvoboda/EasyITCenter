...
```xml   
<UserControl
    x:Class="EasyITSystemCenter.Pages.TemplateClassListAutoDBTranslationWithParentPage"
    ...
    <Grid
        ...
        <Grid
            ...
            <ComboBox
                ...
                Margin="0,2,0,2" HorizontalAlignment="Stretch" VerticalAlignment="Center"
                Controls:TextBoxHelper.ClearTextButton="false" Controls:TextBoxHelper.IsWaitingForData="True" DisplayMemberPath="ParentName" IsEnabled="true" SelectedValuePath="Id" />
