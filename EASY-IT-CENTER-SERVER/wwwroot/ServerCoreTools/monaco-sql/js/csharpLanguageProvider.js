async function sendRequest(type, request) {
    let endPoint;
    switch (type) {
        case 'complete': endPoint = '/MonacoCompletion/complete'; break;
        case 'signature': endPoint = '/MonacoCompletion/signature'; break;
        case 'hover': endPoint = '/MonacoCompletion/hover'; break;
        case 'codeCheck': endPoint = '/MonacoCompletion/codeCheck'; break;
    }
