namespace EASYDATACenter.DBModel {
    ...
    [Table("IncomingInvoiceSupportList")]
    [Index("DocumentNumber", Name = "IX_IncomingInvoiceSupportList")]
    public partial class IncomingInvoiceSupportList {
        ...
        [ForeignKey("UserId")]
        [InverseProperty("IncomingInvoiceSupportLists")]
