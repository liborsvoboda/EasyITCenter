namespace EASYDATACenter.DBModel {
    ...
    [Table("IncomingOrderSupportList")]
    [Index("DocumentNumber", Name = "IX_IncomingOrderSupportList")]
    public partial class IncomingOrderSupportList {
        ...
        [ForeignKey("UserId")]
        [InverseProperty("IncomingOrderSupportLists")]
