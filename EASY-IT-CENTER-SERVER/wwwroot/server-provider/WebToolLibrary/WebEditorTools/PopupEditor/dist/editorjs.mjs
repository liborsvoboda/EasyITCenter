...
function me(r, e, t = "log", o, i = "color: inherit") {
  ...
  o && s.push(o);
  const a = "Editor.js 2.30.0-rc.1", l = `line-height: 1em;
            color: #006FEA;
...
function io(r, e) {
  ...
  return M(t) ? t(r) : G(t) ? r[t] : (t !== void 0 && T("Conversion «export» property must be a string or function. String means key of saved data object to export. Function should export processed string to export."), "");
}
function no(r, e) {
      ...
      function H(v, g) {
        ...
        if (g.singleton) {
          ...
          v.sourceMap && typeof URL == "function" && typeof URL.createObjectURL == "function" && typeof URL.revokeObjectURL == "function" && typeof Blob == "function" && typeof btoa == "function" ? (w = function(B) {
            ...
            var Q = ce.css, Te = ce.sourceMap, Dt = U.convertToAbsoluteUrls === void 0 && Te;
            (U.convertToAbsoluteUrls || Dt) && (Q = m(Q)), Te && (Q += `
/*# sourceMappingURL=data:application/json;base64,` + btoa(unescape(encodeURIComponent(JSON.stringify(Te)))) + " */");
      ...
      var z, J = (z = [], function(v, g) {
        return z[v] = g, z.filter(Boolean).join(`
`);
      });
      function le(v, g, w, E) {
        var I = w ? "" : E.css;
...
class qo extends y {
  ...
  open(e = this.Editor.BlockManager.currentBlock) {
    ...
    this.eventsDispatcher.emit(this.events.opened), this.popover = new wt({
      ...
      messages: {
        nothingFound: $.ui(K.ui.popover, "Nothing found"),
        search: $.ui(K.ui.popover, "Filter")
      }
...
class j extends y {
  ...
  make() {
    ...
    const e = d.make("div", j.CSS.conversionToolbarLabel, {
      textContent: $.ui(K.ui.inlineToolbar.converter, "Convert to")
    });
  ...
  addTool(e, t) {
    ...
    o.dataset.tool = e, i.innerHTML = t.icon, d.append(o, i), d.append(o, d.text($.t(K.toolNames, t.title || se(e))));
...
const Fe = class Bt extends Be {
  ...
  get toolboxItemsToBeDisplayed() {
    const e = (t, o) => ({
      icon: t.icon,
      title: $.t(K.toolNames, t.title || se(o.name)),
      name: o.name,
      onActivate: () => {
...
class ii extends y {
  ...
  async make() {
    ...
    const e = d.make("div");
    e.appendChild(document.createTextNode($.ui(K.ui.toolbar.toolbox, "Add"))), e.appendChild(d.make("div", this.CSS.plusButtonShortcut, {
      textContent: "/"
    ...
    const t = d.make("div"), o = d.text($.ui(K.ui.blockTunes.toggler, "Click to tune")), i = await oi("Slash", "/");
  ...
  enableModuleBindings() {
    ...
    }, !0), te() || this.eventsDispatcher.on(Ct, (e) => {
      var t;
...
var Ce = /* @__PURE__ */ ((r) => (r[r.Block = 0] = "Block", r[r.Inline = 1] = "Inline", r[r.Tune = 2] = "Tune", r))(Ce || {}), ve = /* @__PURE__ */ ((r) => (r.Shortcut = "shortcut", r.Toolbox = "toolbox", r.EnabledInlineTools = "inlineToolbar", r.EnabledBlockTunes = "tunes", r.Config = "config", r))(ve || {}), Tt = /* @__PURE__ */ ((r) => (r.Shortcut = "shortcut", r.SanitizeConfig = "sanitize", r))(Tt || {}), ne = /* @__PURE__ */ ((r) => (r.IsEnabledLineBreaks = "enableLineBreaks", r.Toolbox = "toolbox", r.ConversionConfig = "conversionConfig", r.IsReadOnlySupported = "isReadOnlySupported", r.PasteConfig = "pasteConfig", r))(ne || {}), He = /* @__PURE__ */ ((r) => (r.IsInline = "isInline", r.Title = "title", r))(He || {}), St = /* @__PURE__ */ ((r) => (r.IsTune = "isTune", r))(St || {});
class ze {
  /**
   * @class
...
class ni extends y {
  ...
  addConversionToggler() {
    ...
    }), te() === !1 && ge(this.nodes.conversionToggler, $.ui(K.ui.inlineToolbar.converter, "Convert to"), {
      placement: "top",
      hidingDelay: 100
    });
  }
  ...
  getToolShortcut(e) {
    ...
    return Array.from(i.keys()).includes(e) ? this.inlineTools[e][Tt.Shortcut] : o.shortcut;
  }
  /**
...
class si extends y {
   ...
   */
  arrowRightAndDown(e) {
    const t = q.usedKeys.includes(e.keyCode) && (!e.shiftKey || e.keyCode === x.TAB);
  ...
  arrowLeftAndUp(e) {
    if (this.Editor.UI.someToolbarOpened) {
      if (q.usedKeys.includes(e.keyCode) && (!e.shiftKey || e.keyCode === x.TAB))
        return;
  ...
  needToolbarClosing(e) {
    const t = e.keyCode === x.ENTER && this.Editor.Toolbar.toolbox.opened, o = e.keyCode === x.ENTER && this.Editor.BlockSettings.opened, i = e.keyCode === x.ENTER && this.Editor.InlineToolbar.opened, n = e.keyCode === x.ENTER && this.Editor.ConversionToolbar.opened, s = e.keyCode === x.TAB;
...
const Qe = "block-removed", et = "block-added", ri = "block-moved", tt = "block-changed";
class ai {
  constructor() {
...
class li extends y {
  ...
  move(e, t = this.currentBlockIndex) {
    ...
    this._blocks.move(e, t), this.currentBlockIndex = e, this.blockDidMutated(ri, this.currentBlock, {
      fromIndex: t,
      toIndex: e
    });
  }
...
const It = class Mt extends y {
  ...
  async processDataTransfer(e, t = !1) {
    ...
    if ((i.includes ? i.includes("Files") : i.contains("Files")) && !W(this.toolsFiles)) {
  ...
  getFilesConfig(e) {
    ...
    !o && !i || (o && !Array.isArray(o) && (T(`«extensions» property of the onDrop config for «${e.name}» Tool should be an array`), o = []), i && !Array.isArray(i) && (T(`«mimeTypes» property of the onDrop config for «${e.name}» Tool should be an array`), i = []), i && (i = i.filter((n) => Yt(n) ? !0 : (T(`MIME type value «${n}» for the «${e.name}» Tool is not a valid MIME type`, "warn"), !1))), this.toolsFiles[e.name] = {
      extensions: o || [],
      mimeTypes: i || []
    });
  }
   ...
   */
  getPatternsConfig(e) {
    e.pasteConfig === !1 || !e.pasteConfig.patterns || W(e.pasteConfig.patterns) || Object.entries(e.pasteConfig.patterns).forEach(([t, o]) => {
...
const mi = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M8 9V7.2C8 7.08954 8.08954 7 8.2 7L12 7M16 9V7.2C16 7.08954 15.9105 7 15.8 7L12 7M12 7L12 17M12 17H10M12 17H14"/></svg>';
/**
...
var xi = Object.defineProperty, wi = Object.getOwnPropertyDescriptor, At = (r, e, t, o) => {
  for (var i = o > 1 ? void 0 : o ? wi(e, t) : e, n = r.length - 1, s; n >= 0; n--)
    (s = r[n]) && (i = (o ? s(e, t, i) : s(i)) || i);
  return o && i && xi(e, t, i), i;
};
class Ye extends ze {
  constructor() {
...
Nt.isTune = !0;
var Ei = Object.defineProperty, Bi = Object.getOwnPropertyDescriptor, Ci = (r, e, t, o) => {
  for (var i = o > 1 ? void 0 : o ? Bi(e, t) : e, n = r.length - 1, s; n >= 0; n--)
    (s = r[n]) && (i = (o ? s(e, t, i) : s(i)) || i);
...
class Rt extends y {
  ...
  async prepare() {
    ...
    this.factory = new yi(e, this.config, this.Editor.API);
...
class Ii extends y {
  ...
  loadStyles() {
    ...
    this.config.style && !W(this.config.style) && this.config.style.nonce && t.setAttribute("nonce", this.config.style.nonce), d.prepend(document.head, t);
  }
  /**
  ...
  watchBlockHoveredEvents() {
    ...
    this.readOnlyMutableListeners.on(this.nodes.redactor, "mousemove", Me((t) => {
      ...
      this.Editor.BlockSelection.anyBlockSelected || o && e !== o && (e = o, this.eventsDispatcher.emit(Ct, {
...
class Li {
  ...
  set configuration(e) {
    ...
    }), this.config.inlineToolbar = this.config.inlineToolbar !== void 0 ? this.config.inlineToolbar : !0, (W(this.config.data) || !this.config.data.blocks || this.config.data.blocks.length === 0) && (this.config.data = { blocks: [t] }), this.config.readOnly = this.config.readOnly || !1, (o = this.config.i18n) != null && o.messages && $.setDictionary(this.config.i18n.messages), this.config.i18n.direction = ((i = this.config.i18n) == null ? void 0 : i.direction) || "ltr";
  }
  /**
