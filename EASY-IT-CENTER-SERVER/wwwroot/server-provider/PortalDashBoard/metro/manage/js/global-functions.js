...
//Function Example of Download CSV File
globalThis.downloadCsv = function (array) {
    ...
    if (array) {
        ...
        const data = [
            { firstName: 'Idorenyin', lastName: 'Udoh' },
            { firstName: 'Loyle', lastName: 'Carner' },
            { firstName: 'Tamunotekena', lastName: 'Dagogo' }
        ]
...
//Function Show Alet InfoMox
globalThis.showInfobox = (message) => {
    infobox({ overlayColor: "#f00", message: message, title: "Infobox", clsInfobox: "alert" })
}
