...
function main() {
  ...
  const label = new import_nodegui.QLabel();
  label.setObjectName("mylabel");
  label.setText("Hello");
  const button = new import_nodegui.QPushButton();
  button.setIcon(new import_nodegui.QIcon(path.join(__dirname, "../assets/logox200.png")));
  const label2 = new import_nodegui.QLabel();
