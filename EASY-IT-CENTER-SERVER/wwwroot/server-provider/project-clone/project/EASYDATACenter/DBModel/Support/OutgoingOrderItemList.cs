namespace EASYDATACenter.DBModel {
    ...
    [Table("OutgoingOrderSupportList")]
    [Index("DocumentNumber", Name = "IX_OutgoingOrderSupportList")]
    public partial class OutgoingOrderSupportList {
        ...
        [ForeignKey("UserId")]
        [InverseProperty("OutgoingOrderSupportLists")]
