...
BEGIN 
	...
	INSERT INTO [dbo].[DocSrvDocTemplateList] ([GroupId],[Sequence],[Name],[Description],[Template],[UserId])
	SELECT 8,2000, 
	...
	INSERT INTO [dbo].[DocSrvDocTemplateList] ([GroupId],[Sequence],[Name],[Description],[Template],[UserId])
	SELECT 8,1000,CONCAT('TBL ',tl.[TableName]),'TABLE',tdl.[Template],1 FROM @TableList tl LEFT JOIN @TableDefinitionList tdl ON tl.RowNum = tdl.RowNum;
...
CREATE procedure [dbo].[DB_INFO_HELP](@itemId int, @count int, @userId int)
AS
BEGIN 
	SET NOCOUNT ON;
	BEGIN TRAN
