...
RESENI PRO REACT NATIVE Standalone WEB SERVERS na vlastnich portech (nastroj pro Check OpenPortu)
...
1. SYSTEM Přenastavit seznam IT Nástroje a Manuály - Vypublikovat na Web v Novem Desktopu
---    ### StaticWebStore     
