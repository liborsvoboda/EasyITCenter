...
function rewriteSolutionExplorerLink(link) {
	...
	//Repair Link
    let linkParts = link.href.toLowerCase().split("eic&esbcodebrowser/index/");
    link.href = linkParts[0] + "EIC&ESBCodeBrowser/index/" + linkParts[1] + linkParts[2];
...
function addToolbar() {
    ...
    documentOutlineButton.setAttribute('src', '/EIC&ESBCodeBrowser/index/content/icons/DocumentOutline.png');
    ...
    var projectExplorerIcon = '/EIC&ESBCodeBrowser/index/content/icons/CSharpProjectExplorer.png';
    if (document.title.slice(document.title.length - 2) == "vb") {
        projectExplorerIcon = '/EIC&ESBCodeBrowser/index/content/icons/VBProjectExplorer.png';
    }
    ...
    namespaceExplorerButton.setAttribute('src', '/EIC&ESBCodeBrowser/index/content/icons/NamespaceExplorer.png');
...
function showDocumentOutline() {
    top.n.location = "/EIC&ESBCodeBrowser/index/documentoutline.html";
}
