...
function addToolbar() {
    ...
    documentOutlineButton.setAttribute('src', '/SourceBrowser/index/content/icons/DocumentOutline.png');
    ...
    var projectExplorerIcon = '/SourceBrowser/index/content/icons/CSharpProjectExplorer.png';
    if (document.title.slice(document.title.length - 2) == "vb") {
        projectExplorerIcon = '/SourceBrowser/index/content/icons/VBProjectExplorer.png';
    }
    ...
    namespaceExplorerButton.setAttribute('src', '/SourceBrowser/index/content/icons/NamespaceExplorer.png');
