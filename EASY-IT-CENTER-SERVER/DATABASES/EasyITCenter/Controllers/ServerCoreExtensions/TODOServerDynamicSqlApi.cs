namespace EasyITCenter.ServerCoreDBSettings {
    ...
    public class ServerDynamicSqlApi : ControllerBase {
        ...
        public async Task<string> GetDynamicSql(string sqlquery) {
            try {
                if (CommunicationController.IsAdmin()) {
                    var data = new EasyITCenterContext().EasyITCenterCollectionFromSql<CustomString>("EXEC " + sqlquery); ;
        ...
        public async Task<string> GetDynamicSqlById(int id) {
            try {
                if (CommunicationController.IsAdmin()) {
                    var data = new EasyITCenterContext().EasyITCenterCollectionFromSql<CustomString>("EXEC "); ;
