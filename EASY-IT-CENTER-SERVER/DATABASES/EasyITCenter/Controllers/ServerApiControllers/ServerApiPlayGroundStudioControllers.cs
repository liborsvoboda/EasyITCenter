...
namespace EasyITCenter.Controllers {
    ...
    [ApiController]
    [Route("ServerApi/PlayGroundStudio")]
    public class PlayGroundStudioControllers : Controller {
        ...
        [HttpGet("/ServerApi/PlayGroundStudio/test")]
        public IActionResult Test() {
            return Json(new { test = "test" });
        }


        [HttpGet("/ServerApi/PlayGroundStudio/output/{id}/{milestone}")]
        ...
        [HttpPost("/ServerApi/PlayGroundStudio/newFile")]
        ...
        [HttpGet("/ServerApi/PlayGroundStudio/loadFile")]
        ...
        [HttpPost("/ServerApi/PlayGroundStudio/saveFile")]
        ...
        [HttpGet("/ServerApi/PlayGroundStudio/listFiles")]
        ...
        [HttpPost("/ServerApi/PlayGroundStudio/createMilestone")]
        ...
        [HttpPost("/ServerApi/PlayGroundStudio/deleteMilestone")]
        ...
        [HttpPost("/ServerApi/PlayGroundStudio/updateDescription")]
