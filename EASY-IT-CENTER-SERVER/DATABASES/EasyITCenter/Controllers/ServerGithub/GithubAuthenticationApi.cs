...
namespace EasyITCenter.GitServer.Handlers
{
    public class BasicAuthenticationHandler : AuthenticationHandler<BasicAuthenticationOptions>
    {
        ...
        protected async override Task<AuthenticateResult> HandleAuthenticateAsync()
        {
            ...
            ClaimsPrincipal principal = null;// await Options.SignInAsync(credentials[0], credentials[1]);
    ...
    public class BasicAuthenticationOptions : AuthenticationSchemeOptions, IOptions<BasicAuthenticationOptions>
    {
        ...
        //    {
        //        //var _user = serviceScope.ServiceProvider.GetService<IGitRepository<SolutionUserList>>();
