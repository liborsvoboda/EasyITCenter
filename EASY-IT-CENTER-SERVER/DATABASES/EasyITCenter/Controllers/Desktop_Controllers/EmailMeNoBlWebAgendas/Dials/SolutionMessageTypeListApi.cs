    ...
    public class SolutionMessageTypeListApi : ControllerBase {
        ...
        public async Task<string> GetSolutionMessageTypeList() {
            ...
            using (new TransactionScope(TransactionScopeOption.Required, new TransactionOptions {
                ...
                data = new EasyITCenterContext().SolutionMessageTypeLists.ToList();
            }
        ...
        public async Task<string> GetSolutionMessageTypeListByFilter(string filter) {
            ...
            {
                data = new EasyITCenterContext().SolutionMessageTypeLists.FromSqlRaw("SELECT * FROM SolutionMessageTypeList WHERE 1=1 AND " + filter.Replace("+", " ")).AsNoTracking().ToList();
            }
        ...
        public async Task<string> GetSolutionMessageTypeListKey(int id) {
            ...
            {
                data = new EasyITCenterContext().SolutionMessageTypeLists.Where(a => a.Id == id).First();
            }
