...
namespace EasyITCenter.ServerCoreDBSettings {
    ...
    [Route("ServerGenericApi/[controller]")]
    [ApiController]
    public abstract class StdFreeGenericProviderApi<DbEntity, Tentity, TKey> : ControllerBase where DbEntity : EasyITCenterContext where Tentity : class where TKey : notnull {
        private readonly IGenericApiServiceAsync<DbEntity, Tentity> db;

        public StdFreeGenericProviderApi(IGenericApiServiceAsync<DbEntity, Tentity> repo) => db = repo;
