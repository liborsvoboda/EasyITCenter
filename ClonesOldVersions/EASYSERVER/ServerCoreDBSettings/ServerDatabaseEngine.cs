...
namespace EASYDATACenter.ServerCoreDBSettings {
    ...
    public static class DatabaseContextExtensions {
        ...
        public static List<T> EASYDATACenterCollectionFromSql<T>(this EASYDATACenterContext dbContext, string sql) where T : class, new() {
        ...
        public static List<T> SHOPINGERCollectionFromSql<T>(this EASYDATACenterContext dbContext, string sql) where T : class, new() {
            using var cmd = dbContext.Database.GetDbConnection().CreateCommand();
            cmd.CommandText = sql;
            if (cmd.Connection.State != ConnectionState.Open)
                cmd.Connection.Open();
