    ...
    public class ServerConfigurationServices {
        ...
        internal static void ConfigureAuthentication(ref IServiceCollection services) {
            ...
            .AddJwtBearer(x => {
                ...
                if (ServerConfigSettings.ServerTimeTokenValidationEnabled) { x.TokenValidationParameters.LifetimeValidator = SHOPINGERAuthenticationApi.LifetimeValidator; }
        ...
        internal static void ConfigureDatabaseContext(ref IServiceCollection services) {
            ...
            services.AddDbContext<SHOPINGERContext>(opt => opt.UseSqlServer(ServerConfigSettings.DatabaseConnectionString)
