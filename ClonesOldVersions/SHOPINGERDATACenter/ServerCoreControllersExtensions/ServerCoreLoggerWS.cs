    ...
    public class ServerCoreLoggerWS : ControllerBase {
        ...
        public async Task GetBySocketAPIPath(string socketAPIPath) {
            if (HttpContext.WebSockets.IsWebSocketRequest) {
                ...
                ServerCoreHelpers.AddSocketConnectionToCentalList(webSocket, socketAPIPath);
                await ServerCoreHelpers.ListenClientWebSocketMessages(webSocket, socketAPIPath);
            } else {
        ...
        public async Task Get() {
            if (HttpContext.WebSockets.IsWebSocketRequest) {
                ...
                ServerCoreHelpers.AddSocketConnectionToCentalList(webSocket, "");
                await ServerCoreHelpers.ListenClientWebSocketMessages(webSocket, "");
