...
namespace EASYDATACenter.ServerCoreDBSettings {
    ...
    /// </summary>
    public partial class SHOPINGERContext : ScaffoldContext {

        public SHOPINGERContext() {
        }

        public SHOPINGERContext(DbContextOptions<ScaffoldContext> options)
            : base(options) {
    ...
    public static class DatabaseContextExtensions {
        ...
        public static List<T> EASYDATACenterCollectionFromSql<T>(this SHOPINGERContext dbContext, string sql) where T : class, new() {
        ...
        public static List<T> SHOPINGERCollectionFromSql<T>(this ScaffoldContext dbContext, string sql) where T : class, new() {
            using var cmd = dbContext.Database.GetDbConnection().CreateCommand();
            cmd.CommandText = sql;
            if (cmd.Connection.State != ConnectionState.Open)
                cmd.Connection.Open();
