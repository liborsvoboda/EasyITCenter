    ...
    public class ServerConfigurationServices {
        ...
        internal static void ConfigureAuthentication(ref IServiceCollection services) {
            ...
            .AddJwtBearer(x => {
                ...
                if (ServerConfigSettings.ServerTimeTokenValidationEnabled) { x.TokenValidationParameters.LifetimeValidator = LicenseSHOPERAuthenticationApi.LifetimeValidator; }
        ...
        internal static void ConfigureDatabaseContext(ref IServiceCollection services) {
            ...
            services.AddDbContext<LicenseSHOPERContext>(opt => opt.UseSqlServer(ServerConfigSettings.DatabaseConnectionString)
