        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModelXml = table.Column<string>(type: "TEXT", nullable: true),
                    TeamId = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TeamId = table.Column<string>(type: "TEXT", nullable: true),
                    TimetableRecordId = table.Column<string>(type: "TEXT", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ScheduledJobLogs_Teams_TeamId",
                        column: x => x.TeamId,
                        principalTable: "Teams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NextActionTime = table.Column<DateTime>(type: "TEXT", nullable: false),
                    ExtraDataJson = table.Column<string>(type: "TEXT", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Timetable_Teams_TeamId",
                        column: x => x.TeamId,
                        principalTable: "Teams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScheduledJobLogs_TeamId",
                table: "ScheduledJobLogs",
                column: "TeamId");

            migrationBuilder.CreateIndex(
                name: "IX_ScheduledJobLogs_TimetableRecordId",
                table: "ScheduledJobLogs",
                column: "TimetableRecordId");

            migrationBuilder.CreateIndex(
                name: "IX_Timetable_TeamId",
                table: "Timetable",
                column: "TeamId");
