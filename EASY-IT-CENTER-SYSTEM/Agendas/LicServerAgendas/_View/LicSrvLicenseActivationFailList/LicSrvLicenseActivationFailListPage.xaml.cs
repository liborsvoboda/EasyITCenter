        ...
        public async Task<bool> LoadDataList() {
            ...
            try {
                if (MainWindow.serviceRunning) {
                    DgListView.ItemsSource = await CommApi.GetApiRequest<List<LicSrvLicenseActivationFailList>>(ApiUrls.EasyITCenterLicSrvLicenseActivationFailList, (dataViewSupport.AdvancedFilter == null) ? null : "Filter/" + WebUtility.UrlEncode(dataViewSupport.AdvancedFilter.Replace("[!]", "").Replace("{!}", "")), App.UserData.Authentification.Token);
                }
