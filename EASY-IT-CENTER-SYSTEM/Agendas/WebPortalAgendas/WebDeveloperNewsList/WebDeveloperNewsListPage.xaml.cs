...
namespace EasyITSystemCenter.Pages {
    ...
    public partial class WebDeveloperNewsListPage : UserControl {
        ...
        public async Task<bool> LoadDataList() {
            ...
            try {
                webDeveloperNewsList = await CommApi.GetApiRequest<List<WebDeveloperNewsList>>(ApiUrls.EasyITCenterWebDeveloperNewsList, (dataViewSupport.AdvancedFilter == null) ? null : "Filter/" + WebUtility.UrlEncode(dataViewSupport.AdvancedFilter.Replace("[!]", "").Replace("{!}", "")), App.UserData.Authentification.Token);
        ...
        public async void DeleteRecord() {
            ...
            if (result == MessageDialogResult.Affirmative) {
                DBResultMessage dBResult = await CommApi.DeleteApiRequest(ApiUrls.EasyITCenterWebDeveloperNewsList, selectedRecord.Id.ToString(), App.UserData.Authentification.Token);
        ...
        private async void BtnSave_Click(object sender, RoutedEventArgs e) {
            try {
                ...
                selectedRecord.Description = html_description.Browser.GetCurrentHtml();
                ...
                if (selectedRecord.Id == 0) {
                    dBResult = await CommApi.PutApiRequest(ApiUrls.EasyITCenterWebDeveloperNewsList, httpContent, null, App.UserData.Authentification.Token);
                }
                else { dBResult = await CommApi.PostApiRequest(ApiUrls.EasyITCenterWebDeveloperNewsList, httpContent, null, App.UserData.Authentification.Token); }
        ...
        private void SetRecord(bool? showForm = null, bool copy = false) {
            ...
            html_description.HtmlContent = selectedRecord.Description;
