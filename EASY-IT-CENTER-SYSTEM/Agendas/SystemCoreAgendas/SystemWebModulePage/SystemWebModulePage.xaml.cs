...
namespace EasyITSystemCenter.Pages {
    ...
    public partial class SystemWebModulePage : UserControl {

        public static DataViewSupport dataViewSupport = new DataViewSupport();
        public static Object selectedRecord = new Object();


        public SystemWebModulePage() {
            try {

                InitializeComponent();
                InitializeAsync();
                _ = SystemOperations.SetLanguageDictionary(Resources, App.appRuntimeData.AppClientSettings.First(a => a.Key == "sys_defaultLanguage").Value);
                _ = DataOperations.TranslateFormFields(moduleForm);
        ...
        public async Task<bool> LoadDataList() {
            ...
            try {
                ...
                //webViewer.BeginInit();
                webViewer.Source = new Uri(App.appRuntimeData.AppClientSettings.First(a => a.Key == "sys_localWebServerUrl").Value + App.appRuntimeData.webDataPath + multiWebView.StartupSubFolder);
                webHelp.Source = new Uri(App.appRuntimeData.AppClientSettings.First(a => a.Key == "sys_localWebServerUrl").Value + App.appRuntimeData.webDataPath + "/SystemWebModules/markdown/help.html");
