        ...
        private void DgListView_Translate(object sender, EventArgs ex) {
            try {
                ((DataGrid)sender).Columns.ToList().ForEach(e => {
                    ...
                    if (headername == "PageName") e.Header = Resources["pageName"].ToString();
        ...
        public void Filter(string filter) {
            try {
                ...
                DgListView.Items.Filter = (e) => {
                    SystemCustomPageList user = e as SystemCustomPageList;
                    return user.PageName.ToLower().Contains(filter.ToLower())
